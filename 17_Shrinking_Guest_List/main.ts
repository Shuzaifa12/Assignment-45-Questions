...
let array = ['Moscow', 'Rio', 'Alicia', 'Berlin', 'Professor', 'Denver']
array.forEach(array=>{
    console.log(`${array}, I would like to invite you for dinner \n`)
})
...
let name_1 = array.pop()
console.log(`${name_1}, I am sorry you are not invited today`)
let name_2 = array.pop()
console.log(`${name_2}, I am sorry you are not invited today`)
let name_3 = array.pop()
console.log(`${name_3}, I am sorry you are not invited today`)
let name_4 = array.pop()
console.log(`${name_4}, I am sorry you are not invited today`)

// Printing the statement for the person who are still invited:
array.forEach(array => {
    console.log(`${array}, You are still invited for dinner today.`)
});
