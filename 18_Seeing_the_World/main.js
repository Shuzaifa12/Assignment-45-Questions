...
var places = ['Dubai', 'Russia', 'Turkey', 'Italy', 'Canada'];
console.log("Original Order :", places); // 1) Original form
console.log("Alphabetic Order :", __spreadArray([], places, true).sort()); // 2) sort function is used for Alphabetical order. these 3 dots are used to deconstruct the array into variables and known as spread syntax/operator.
console.log("Original Order :", places); // still original order
console.log("Reverse order :", __spreadArray([], places, true).sort().reverse()); // first make in alphabetic order again by sort function and then reverse it
