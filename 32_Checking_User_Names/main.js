...
var current_users = ['Elizabeth', 'Saqlain', 'Bilgades', 'Tiger', 'Hira'];
var new_users = ['James', 'Sarmad', 'Saqlain', 'Tiger', 'Rida'];
new_users.forEach(function (new_users) {
    if (current_users.some(function (current_users) { return current_users === new_users; })) {
        ...
        console.log("".concat(new_users, ", User name is available."));
    }
});
